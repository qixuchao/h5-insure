...
<template>
  <div class="guarantee-list">
    <ProCard title="保障计划" link="查看详情" :show-divider="true" :show-icon="true" @link-click="onShowDetail">
    ...
    <div class="guarantee-detail">
      ...
      <div v-if="extInfoVOList && extInfoVOList.length > 0">
        <div class="extinfo-info-list">
          <div v-for="(item, index) in extInfoVOList" :key="index" class="extinfo-info-list-item">
            <span>{{ item.name }}</span>
