 ...
 * @LastEditTime: 2023-02-03 17:01:57
  ...
  <div class="page-info-wrapper">
    <ProForm ref="formRef" show-error :show-error-message="false" :input-align="inputAlign">
      ...
      >
        ...
        <ProField
          v-if="showByFactor('social', 'INSURER')"
          v-model="formInfo.tenantOrderInsuredList[0].extInfo.hasSocialInsurance"
          :label="queryFactorAttr('social', 'title', 'INSURER')"
          name="insure_hasSocialInsurance"
          :required="isRequiredByFactor('social', 'INSURER')"
        >
          <template #input>
            <ProRadioButton
              v-model="formInfo.tenantOrderInsuredList[0].extInfo.hasSocialInsurance"
