...
import { OrderListResponse, OrderDetail, NewOrderListResponse, InsureRecordData } from './order.data';
...
export const orderInsureRecord = (data = {}) =>
  request<InsureRecordData>({ url: '/api/app/insure/insurance/orderInsureRecord', method: 'POST', data });
