...
export function watermark(settings) {
  function init() {
    ...
    // 获取页面最大高度
    const pageHeight = Math.max(document.body.scrollHeight, document.body.clientHeight) - 30;
  ...
  function clear() {
    document.querySelectorAll('.maskDiv').forEach((el) => {
